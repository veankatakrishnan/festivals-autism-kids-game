...
class Quiz extends React.Component {
    ...
    handleOptionClick = (option) => {
        if (this.state.feedback) return; // Prevent clicking during feedback

        const festival = this.getFestival();
        const currentQuestion = festival.quiz[this.state.currentQuestionIndex];
        ...
        setTimeout(() => {
            this.setState(prevState => {
                ...
                const isLastQuestion = prevState.currentQuestionIndex >= festival.quiz.length - 1;
    ...
    render() {
        ...
        const { currentQuestionIndex, selectedOption, showHint, score, history, quizCompleted, feedback } = this.state;
        ...
        return (
            <div style={{ maxWidth: '800px', margin: '0 auto', padding: '1rem', minHeight: '80vh', display: 'flex', flexDirection: 'column' }}>
                ...
                <motion.div
                    key={currentQuestion.id} // Ensure key changes to trigger animation
